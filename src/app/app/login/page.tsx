    ...
    <div className="min-h-[100dvh] flex flex-col bg-background px-6">
      ...
      <div className="flex flex-col items-center pt-16 pb-8">
        <div className="h-16 w-16 rounded-2xl bg-primary/10 flex items-center justify-center mb-4">
          <Image src="/logo-mark.png" alt="Selah" width={40} height={40} className="rounded-sm" />
        </div>
        <h1 className="text-2xl font-bold">Welcome back</h1>
        <p className="text-muted-foreground text-sm mt-1">Sign in to your Selah account</p>
      </div>
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-4 w-full max-w-sm mx-auto">
        ...
        <div className="space-y-1.5">
          <div className="flex items-center justify-between">
            ...
            <Link href="/app/forgot-password" className="text-xs text-primary">
              Forgot password?
            </Link>
          </div>
        ...
        <Button type="submit" className="w-full h-12 rounded-2xl font-semibold" variant="gold" disabled={loading}>
