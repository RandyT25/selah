          ...
          <CardContent className="p-6">
            ...
            <div className="mt-4 flex gap-2">
              <Button size="sm" variant="gold" asChild>
                <Link href="/bible">Read Chapter</Link>
              </Button>
              <Button size="sm" variant="outline" asChild>
                <Link href="/ai">Explore with AI</Link>
              </Button>
            </div>
          </CardContent>
        </Card>
          ...
          {featuredDevotionals.length > 0 && (
            <div>
              <div className="flex items-center justify-between mb-3">
                ...
                <Button variant="ghost" size="sm" asChild>
                  <Link href="/devotionals" className="text-primary">
            ...
            <CardHeader className="pb-3">
              <div className="flex items-center justify-between">
                ...
                <Button variant="ghost" size="icon-sm" asChild>
                  <Link href="/journal"><ChevronRight className="h-4 w-4" /></Link>
                </Button>
              </div>
            </CardHeader>
          ...
          <Card>
            <CardHeader className="pb-3">
              <div className="flex items-center justify-between">
                ...
                <Button variant="ghost" size="icon-sm" asChild>
                  <Link href="/community/prayer"><ChevronRight className="h-4 w-4" /></Link>
                </Button>
              </div>
            </CardHeader>
            <CardContent className="pb-4 space-y-3">
              ...
              <Button size="sm" className="w-full" variant="outline" asChild>
                <Link href="/community/prayer">View All Requests</Link>
              </Button>
            </CardContent>
          </Card>
        </div>
